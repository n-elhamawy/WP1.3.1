...
set SCAN_COUNT										[getenv SCAN_COUNT];
...
set ADDITIONAL_SEARCH_PATH " /eda/synopsys/2022-23/RHELx86/SYN_2022.12/libraries/syn ${FOUNDRY_PATH}";
set_app_var search_path ". ${ADDITIONAL_SEARCH_PATH} $search_path"

if {$synopsys_program_name == "dc_shell"}  {
  set_app_var target_library ${TARGET_LIBRARY_FILES}
  set_app_var synthetic_library dw_foundation.sldb
  set_app_var link_library [list "*" "$FOUNDRY_PATH/$TARGET_LIBRARY_FILES" "dw_foundation.sldb"]
}

source -echo -verbose ./tcl_scripts/dc_setup_filenames.tcl
